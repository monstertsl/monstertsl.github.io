...
*/
        ...
        function (e, t, n) {
            ...
            var a = n(26),
                ...
                j = "",
                T = {
                    cdn: "https://gravatar.bigs3.com/avatar/",
                    ...
                    P = function (t, n) {
                        t.on("click", function (r) {
                            ...
                            (0, y.default)('.vreply-wrapper[data-self-id="' + i + '"]').append(a).find(".cancel-reply").show(), I = {
                                ...
                                pid: i,
                                rmail: n.get("mail"),
                                nick: "@" + y.default.escape(n.get("nick"))
                            }, v.comment.attr({
                                placeholder: s
                            })[0].focus()
                        })
                ...
                var z = e.$el.find(".vsubmit"),
                    ...
                    U = function () {
                        ...
                        if (E.url = decodeURI(e.config.path), E.insertedAt = new Date, I.rid) {
                            var r = I.pid || I.rid;
                            n.set("rid", I.rid), n.set("pid", r), E.comment = j.replace("<p>", '<p><a class="at" href="#' + r + '">' + I.nick + "</a> , ")
                        }
                        for (var o in E)
        ...
        function (e, t, n) {
            ...
            t.default = function (e, t) {
                ...
                i ? t && t() : o.default.sdkLoader("https://cdn.jsdelivr.net/npm/leancloud-storage@3/dist/av-min.js", "AV", function (n) {
                    var r = "https://",
                        o = "",
                        a = e.app_id || e.appId,
                ...
                for (var o in r)
                    ...
                    var l = {
                        Windows: function () {
                            ...
                            return {
                                6.4: "10", 6.3: "8.1", 6.2: "8", 6.1: "7", "6.0": "Vista", 5.2: "XP", 5.1: "XP", "5.0": "2000"
                            }[t] || t
